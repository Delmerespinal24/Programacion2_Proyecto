...
public class Tablero {
    ...
    public void moverRebelde(int x1, int y1, int x2, int y2) {
        try {
            if (rebeldes.getPosiciones()[x1][y1]) {
                ...
                JOptionPane.showMessageDialog(null, "No hay ninguna pieza en esta posicion");
            }
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(null, "Fuera del rango del tablero");
        }
    ...
    public void moverRey(int x1, int y1, int x2, int y2) {

        try {
            if (rey.getPosiciones()[x1][y1]) {
                if (!(x2 == 9 && y2 == 9)) {
